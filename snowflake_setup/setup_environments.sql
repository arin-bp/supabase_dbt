...
-- Grant full database + schema control (needed for temporary staging & dbt deployment)
GRANT ALL PRIVILEGES ON DATABASE SUPABASE_DEV TO ROLE DBT_DEV_ROLE;
GRANT ALL PRIVILEGES ON ALL SCHEMAS IN DATABASE SUPABASE_DEV TO ROLE DBT_DEV_ROLE;
GRANT ALL PRIVILEGES ON FUTURE SCHEMAS IN DATABASE SUPABASE_DEV TO ROLE DBT_DEV_ROLE;

GRANT ALL PRIVILEGES ON DATABASE SUPABASE_SIT TO ROLE DBT_SIT_ROLE;
GRANT ALL PRIVILEGES ON ALL SCHEMAS IN DATABASE SUPABASE_SIT TO ROLE DBT_SIT_ROLE;
GRANT ALL PRIVILEGES ON FUTURE SCHEMAS IN DATABASE SUPABASE_SIT TO ROLE DBT_SIT_ROLE;

GRANT ALL PRIVILEGES ON DATABASE SUPABASE_UAT TO ROLE DBT_UAT_ROLE;
GRANT ALL PRIVILEGES ON ALL SCHEMAS IN DATABASE SUPABASE_UAT TO ROLE DBT_UAT_ROLE;
GRANT ALL PRIVILEGES ON FUTURE SCHEMAS IN DATABASE SUPABASE_UAT TO ROLE DBT_UAT_ROLE;

GRANT ALL PRIVILEGES ON DATABASE SUPABASE_PROD TO ROLE DBT_PROD_ROLE;
GRANT ALL PRIVILEGES ON ALL SCHEMAS IN DATABASE SUPABASE_PROD TO ROLE DBT_PROD_ROLE;
GRANT ALL PRIVILEGES ON FUTURE SCHEMAS IN DATABASE SUPABASE_PROD TO ROLE DBT_PROD_ROLE;
